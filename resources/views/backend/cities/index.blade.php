                ...
                <div class="widget-header">
                            ...
                            <nav class="breadcrumb-two" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a
                                            href="javascript:void(0);">Cities</a></li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div
                            ...
                            <a href="{{ route('cms.cities.create') }}" name="txt" class="btn btn-primary mt-2 ml-3 ">
                                Add New City
                            </a>
                        </div>
                            ...
                            <table class="table mb-4">
                                ...
                                <tbody>
                                    @forelse($cities as $city)
                                        <tr>
                                            <td>{{ tableRowSrNo($loop->index, $cities) }}</td>
                                            <td>
                                                {{ $city->name }}
                                            </td>
                                                ...
                                                <div class="dropdown custom-dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.cities.show', $city->id) }}">View</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.cities.edit', $city->id) }}">Edit</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.cities.delete', $city->id) }}"
                        ...
                        <div class="pagination col-lg-12 mt-3">
                            <div class=" text-center mx-auto">
                                <ul class="pagination text-center">
                                    {{ $cities->appends(Request::all())->links('pagination::bootstrap-4') }}
                                </ul>
                            </div>
                        </div>
