        ...
        <div id="tableDropdown" class="col-lg-12 col-12 layout-spacing">
                ...
                <div class="widget-header">
                            ...
                            <nav class="breadcrumb-two" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a
                                            href="javascript:void(0);">Posts</a></li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div
                            ...
                            <a href="{{ route('cms.post.create', $service->id) }}" name="txt"
            ...
            <div class="statbox widget box box-shadow temp-index">
                ...
                <ul class="nav nav-tabs" id="postTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link {{ request('tab') !== 'news' ? 'active' : '' }}" data-toggle="tab"
                            href="#blog">Blogs</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request('tab') === 'news' ? 'active' : '' }}" data-toggle="tab"
                ...
                <div class="tab-content mt-3" id="postTabContent">
                    <!-- Blog Tab -->
                    <div class="tab-pane fade {{ request('tab') !== 'news' ? 'show active' : '' }}" id="blog">
                        <div class="table-responsive min-height-23em">
                            <table class="table mb-4">
                                ...
                                <tbody>
                                    @forelse($blogs as $blog)
                                        <tr>
                                            <td>{{ tableRowSrNo($loop->index, $blogs) }}</td>
                                            <td>
                                                {{ str_limit($blog->title, 90) }}
                                            </td>
                                            <td>
                                                {{ $blog->service->name }}
                                            </td>
                                                ...
                                                <div class="dropdown custom-dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.post.show', ['service_id' => $service->id, 'post_id' => $blog->id]) }}">View</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.post.edit', ['service_id' => $service->id, 'post_id' => $blog->id]) }}">Edit</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.post.delete', ['service_id' => $service->id, 'post_id' => $blog->id]) }}"
                        ...
                        <div class="pagination col-lg-12 mt-3">
                            <div class=" text-center mx-auto">
                                <ul class="pagination text-center">
                                    {{ $blogs->appends(['tab' => 'blog'])->links('pagination::bootstrap-4') }}
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- News Tab -->
                    <div class="tab-pane fade {{ request('tab') === 'news' ? 'show active' : '' }}" id="news">
                        <div class="table-responsive min-height-23em">
                            <table class="table mb-4">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    @forelse($news as $nw)
                                        <tr>
                                            <td>{{ tableRowSrNo($loop->index, $news) }}</td>
                                            <td>
                                                {{ str_limit($nw->title, 90) }}
                                            </td>
                                            <td>
                                                {{ $nw->service->name }}
                                            </td>
                                            <td class="text-center">
                                                <div class="dropdown custom-dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.post.show', ['service_id' => $service->id, 'post_id' => $nw->id]) }}">View</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.post.edit', ['service_id' => $service->id, 'post_id' => $nw->id]) }}">Edit</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.post.delete', ['service_id' => $service->id, 'post_id' => $nw->id]) }}"
                                                            onclick="return confirm('Are you sure you want delete this?');">Delete</a>
                                                    </div>
                                                </div>
                        ...
                        <div class="pagination col-lg-12 mt-3">
                            <div class=" text-center mx-auto">
                                <ul class="pagination text-center">
                                    {{ $news->appends(['tab' => 'news'])->links('pagination::bootstrap-4') }}
                                </ul>
                            </div>
                        </div>
                    </div>
