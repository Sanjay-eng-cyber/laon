                            ...
                            <nav class="breadcrumb-two" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a
                                            href="javascript:void(0);">Inquiries </a></li>
                                </ol>
                            </nav>
                        </div>
                            ...
                            <table class="table mb-4">
                                ...
                                <tbody>
                                    @forelse($inquiries as $inq)
                                        <tr>
                                            <td>{{ tableRowSrNo($loop->index, $inquiries) }}</td>
                                            <td>
                                                {{ $inq->name }}
                                            </td>
                                            <td>
                                                {{ ucWords($inq->service->name) }}
                                            </td>
                                            <td>
                                                {{ $inq->city->name }}
                                            </td>
                                                ...
                                                <div class="dropdown custom-dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.inquiry.show', $inq->id) }}">View</a>
                                                    </div>
                                                </div>
                        ...
                        <div class="pagination col-lg-12 mt-3">
                            <div class=" text-center mx-auto">
                                <ul class="pagination text-center">
                                    {{ $inquiries->appends(Request::all())->links('pagination::bootstrap-4') }}
                                </ul>
                            </div>
                        </div>
