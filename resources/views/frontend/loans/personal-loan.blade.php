                  ...
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                      ...
                      <div class="sub-nav" id="sub-nav">
                          <ul class="nav nav-justified">
                              ...
                              <li class="nav-item"><a href="#section-howApply" class="page-scroll nav-link">How To Apply</a>
                              </li>
                  ...
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                      <div class="wrapper-content bg-white">
                          <div class="section-scroll pinside60" id="section-about">
                              ...
                              <p>Personal loans are sometimes referred to as unsecured loans as you can
                                  obtain them without putting up any collateral. </p>
                              <p>A personal loan allows you to borrow a set amount of money and repay it over time in
                                  monthly payments as instalments. Your loan term could range from one year to seven years,
                                  depending on your loan amount.</p>
                              {{-- <a href="#" class="btn btn-default">Apply for loan</a> --}}
                          </div>
                          <div class="section-scroll" id="section-howApply">
                              <div class="bg-light pinside60">
                                  <div class="row">
                                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                          <div class="section-title mb60">
                                              <h2> How You Can Apply For Personal Loan?</h2>
                                  ...
                                  <div class="row">
                                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                          <div class="feature-blurb mb60">
                                              ...
                                              <p>To contact us, simply complete the contact form with your information. Our
                                                  team will contact you right away to discuss your needs.</p>
                                          </div>
                                      </div>
                                      <div class="col-xl-6 col-lg-6 col-md-62 col-sm-12 col-12">
                                          <div class="feature-blurb mb60">
                                              <h3>Define your Personal loan details</h3>
                                              <p>Our team will assist you with the best possible interest. You need to
                                                  define your repayment period and loan amount based on your eligibility.
                                              </p>
                                          </div>
                                      </div>
                                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                          <div class="feature-blurb mb60">
                                              <h3>Submit your loan application</h3>
                                              <p>To process your loan, you must submit the application form along with the
                                                  KYC, address proof, and income proof documents. Let our team handle the
                                                  rest while you relax.</p>
                                          </div>
                                      </div>
                                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                          <div class="feature-blurb mb60">
                                              <h3>Loan Approval</h3>
                                              <p>Your documents will be reviewed, and the loan will then be granted. Within
                                                  2 to 3 business days, the money is released to you and deposited either by
                                                  cheque or directly into your account.</p>
                                          </div>
                                      </div>
                                  </div>
                              </div>
