                ...
                <div class="widget-header">
                    ...
                    <div class="row">
                        ...
                        <div
                            ...
                            <a href="{{ route('cms.services.create') }}" name="txt" class="btn btn-primary mt-2 ml-3 ">
                                Add New Service
                            </a>
                        </div>
                            ...
                            <table class="table mb-4">
                                ...
                                <tbody>
                                    @forelse($services as $service)
                                        <tr>
                                            <td>{{ tableRowSrNo($loop->index, $services) }}</td>
                                            <td>
                                                {{ $service->name }}
                                            </td>
                                            <td>
                                                ...
                                                <div class="dropdown custom-dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.services.show', $service->id) }}">View</a>
                                                        <a class="dropdown-item"
